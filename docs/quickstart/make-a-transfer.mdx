...
Before you can make a transfer, your wallet needs to have some token balance. You can use [WalletKit Faucet](https://faucet.usewalletkit.com/) to get some test token for free.
