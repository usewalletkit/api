...
description: "Create a free WalletKit account"
---

WalletKit is a set of APIs and no-code tools. To access any of the APIs, you need a `Project ID`. You
can get these for free by creating a WalletKit account.

1. Head over to https://app.walletkit.com and create a free account
2. On the [API Keys](https://app.walletkit.com/api-keys) page, you will see your `Project ID` and `API Key`
