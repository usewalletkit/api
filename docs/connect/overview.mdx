...
Connect is a set of simple and beautiful UI components that you can use with our [wagmi](https://wagmi.sh/) connector. It is the easiest way for your users to onboard your app using their existing wallets or to create a new wallet using their email or social logins.

<Card title="Quickstart" icon="star" href="quickstart">
Integrate Connect in your app using our wagmi connector. It will take less than < 15 minutes if you are already familiar with wagmi.
</Card>
