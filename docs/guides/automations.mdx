...
Click on "Continue". In the next step, copy and paste this URL: `https://testnet.walletkit.com/tokens/transfer`. Select JSON as the Payload Type. Zapier will take the request body from the previous step automatically.
